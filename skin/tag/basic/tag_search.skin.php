...
<aside>
	<div class="div-tab tabs" style="margin-bottom:20px;">
		<ul class="nav nav-tabs nav-justified">
			<li<?php echo ($sort == "actor") ? ' class="active"' : '';?>>
				<a href="./tag_search.php"><b>배우</b></a>
			</li>
			<li<?php echo ($sort == "category") ? ' class="active"' : '';?>>
				<a href="./tag_search.php?sort=category"><b>카테고리</b></a>
			</li>
			<li<?php echo ($sort == "studio") ? ' class="active"' : '';?>>
				<a href="./tag_search.php?sort=studio"><b>제작사</b></a>
			</li>
		</ul>
	</div>
</aside>
...
<?php for($i=0; $i < $list_cnt; $i++) { ?>
	...
	<?php if($list[$i]['is_sp']) { 
		switch($sort) {
			case 'category'	: $tagbox_title = '<i class="fa fa-book fa-lg lightgray"></i> <b>카테고리</b>'; break;	
			case 'studio'	: $tagbox_title = '<i class="fa fa-trophy fa-lg lightgray"></i> <b>제작사</b>'; break;
			default			: $tagbox_title = '<i class="fa fa-book fa-lg lightgray"></i> <b>'.$list[$i]['idx'].'</b>'; break;
		}
	?>
