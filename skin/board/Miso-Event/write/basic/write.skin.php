...
<div class="panel panel-default">
	...
	<div class="panel-body" style="padding-bottom:0px;">
		<div class="form-group">
			<label class="col-sm-2 col-xs-12 control-label" for="sdate">시작</label>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<input type="text" name="sdate" value="<?php echo $sdate; ?>" id="sdate" class="form-control input-sm" size="10" maxlength="10" readonly>
			...
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					...
					<span class="input-group-addon">시 00분</span>
				</div>	
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 col-xs-12 control-label" for="edate">종료</label>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
			...
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					...
					<span class="input-group-addon">시 59분</span>
				</div>	
			</div>
		</div>

		<div class="form-group">
			<label class="col-sm-2 col-xs-12 control-label">방법</label>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label">
					<select name="type" id="type" class="form-control input-sm">
						<option value="">최고입찰</option>
						<option value="1"<?php echo get_selected("1", $type);?>>랜덤당첨</option>
						<option value="2"<?php echo get_selected("2", $type);?>>별도선정</option>
					</select>
				</div>
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<input type="text" name="win" value="<?php echo ($win > 0) ? $win : 1; ?>" id="win" class="form-control input-sm" size="10" maxlength="10">
		...
		<div class="form-group">
			...
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<input type="text" name="entry_point" value="<?php echo ($entry_point > 0) ? $entry_point : 0; ?>" id="entry_point" class="form-control input-sm" size="10" maxlength="10">
					<span class="input-group-addon">포인트</span>
				</div>	
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<input type="text" name="entry_rate" value="<?php echo ($entry_rate > 0) ? $entry_rate : 0; ?>" id="entry_rate" class="form-control input-sm" size="10" maxlength="10">
					<span class="input-group-addon">% 증가</span>
				</div>	
			</div>
			<div class="col-sm-4">
				<p class="form-control-static text-muted">
		...
		<div class="form-group">
			<label class="col-sm-2 col-xs-12 control-label" for="tender_limit">입찰</label>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<input type="text" name="tender_limit" value="<?php echo ($tender_limit > 0) ? $tender_limit : 0; ?>" id="tender_limit" class="form-control input-sm" size="10" maxlength="10">
					<span class="input-group-addon">포인트</span>
				</div>	
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<input type="text" name="tender" value="<?php echo ($tender > 0) ? $tender : 1; ?>" id="entry" class="form-control input-sm" size="10" maxlength="10">
					<span class="input-group-addon">회 가능</span>
				</div>	
			</div>
			<div class="col-sm-4">
				<p class="form-control-static text-muted">
		...
		<div class="form-group">
			<label class="col-sm-2 col-xs-12 control-label" for="as_down">당첨</label>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<input type="text" name="as_down" value="<?php echo ($write['as_down']) ? $write['as_down'] : 0; ?>" id="as_down" class="form-control input-sm" size="10" maxlength="10">
					<span class="input-group-addon">포인트</span>
				</div>	
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<select name="win_pay" class="form-control input-sm">
						<option value="">지정점수</option>
						<option value="1"<?php echo ($win_pay) ? ' selected' : '';?>>참가점수 1/n</option>
					</select>
					<span class="input-group-addon">당첨금</span>
				</div>	
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<input type="text" name="win_fee" value="<?php echo ($win_fee) ? $win_fee : 0; ?>" id="win_fee" class="form-control input-sm" size="10" maxlength="10">
					<span class="input-group-addon">% 공제</span>
				</div>	
			</div>
		</div>

		<div class="form-group">
			<label class="col-sm-2 col-xs-12 control-label">공개</label>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<select name="show_win" class="form-control input-sm">
						<option value="">공개</option>
						<option value="1"<?php echo ($show_win) ? ' selected' : '';?>>비공개</option>
					</select>
					<span class="input-group-addon">당첨자</span>
				</div>	
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<select name="show_tender" class="form-control input-sm">
						<option value="">공개</option>
						<option value="1"<?php echo ($show_tender) ? ' selected' : '';?>>비공개</option>
					</select>
					<span class="input-group-addon">최고가</span>
				</div>	
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<select name="show_tender_win" class="form-control input-sm">
						<option value="">공개</option>
						<option value="1"<?php echo ($show_tender_win) ? ' selected' : '';?>>비공개</option>
					</select>
					<span class="input-group-addon">당첨가</span>
				</div>	
			</div>
		</div>

		<div class="form-group">
			<label class="col-sm-2 col-xs-12 control-label" for="wr_7">협찬</label>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<input type="text" name="wr_7" value="<?php echo $write['wr_7']; ?>" id="wr_7" class="form-control input-sm" size="10">
					<span class="input-group-addon">회원ID</span>
				</div>	
			</div>
			<div class="col-sm-3 col-xs-6">
				<div class="control-label input-group input-group-sm">
					<input type="text" name="wr_8" value="<?php echo ($write['wr_8'] > 0) ? $write['wr_8'] : 0; ?>" id="wr_8" class="form-control input-sm" size="10">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="wr_6">메모</label>
			<div class="col-sm-10">
				<textarea name="wr_6" id="wr_6" rows="3" class="form-control input-sm" maxlength="255" placeholder="협찬에 대한 소개, 감사 등(최대 250자)"><?php echo $write['wr_6']; ?></textarea>
			</div>
		</div>
	</div>
</div>
...
<?php } ?>
<?php if($is_use_tag) { // 추가태그 - wr_10 필드로 값을 옮김 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="as_tag">추가태그</label>
		<div class="col-sm-10">
...
$(function(){
	$("#sdate, #edate").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yy-mm-dd", showButtonPanel: true, yearRange: "c:c+1", minDate: "+0d" });
