...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		<td align="center">상위노출</td>
		<td>
			<input type="text" name="boset[jpp]" value="<?php echo $boset['jpp'];?>" size="8" class="frm_input"> <?php echo AS_MP;?>/일
			&nbsp;
			최대 <input type="text" name="boset[jpc]" value="<?php echo $boset['jpc'];?>" size="4" class="frm_input"> 개 게시물 노출
		</td>
	</tr>
	<tr>
		<td rowspan="3" align="center">열람설정</td>
		<td>
			<label><input type="checkbox" name="boset[urp]"<?php echo ($boset['urp']) ? ' checked' : '';?>> 개별 열람<?php echo AS_MP;?> 등록기능 사용</label>
		</td>
	</tr>
	<tr>
		<td>
			<input type="text" name="boset[rterm]" value="<?php echo $boset['rterm']; ?>" class="frm_input" size="4" maxlength="3"> 일간 열람 이력 유지 (0 또는 미설정시 1번만 <?php echo AS_MP;?> 차감)
		</td>
	</tr>
	<tr>
		<td>
			<input type="text" name="boset[rrp]" value="<?php echo $boset['rrp']; ?>" class="frm_input" size="4" maxlength="3"> % 등록자 적립
			&nbsp;
			최소 <input type="text" name="boset[nrp]" value="<?php echo $boset['nrp'];?>" size="6" class="frm_input"> 
			~
			최대 <input type="text" name="boset[xrp]" value="<?php echo $boset['xrp'];?>" size="6" class="frm_input"> 포인트
			등록 가능	
		</td>
	</tr>
	<tr>
		<td rowspan="3" align="center">다운로드</td>
		<td>
			<label><input type="checkbox" name="boset[udp]"<?php echo ($boset['udp']) ? ' checked' : '';?>> 개별 다운<?php echo AS_MP;?> 등록기능 사용</label>
		</td>
	</tr>
	<tr>
		<td>
			<input type="text" name="boset[dterm]" value="<?php echo $boset['dterm']; ?>" class="frm_input" size="4" maxlength="3"> 일간 다운로드 이력 유지 (0 또는 미설정시 1번만 <?php echo AS_MP;?> 차감)
		</td>
	</tr>
	<tr>
		<td>
			<input type="text" name="boset[rdp]" value="<?php echo $boset['rdp']; ?>" class="frm_input" size="4" maxlength="3"> % 등록자 적립
			&nbsp;
			최소 <input type="text" name="boset[ndp]" value="<?php echo $boset['ndp'];?>" size="6" class="frm_input"> 
			~
			최대 <input type="text" name="boset[xdp]" value="<?php echo $boset['xdp'];?>" size="6" class="frm_input"> 포인트
			등록 가능	
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td align="center">회원제한</td>
		<td>
			<label><input type="checkbox" name="boset[writer]"<?php echo ($boset['writer']) ? ' checked' : '';?>> 지정된 회원만 글등록 가능(회원아이디 콤마로 구분)</label>
			<div style="height:8px;"></div>
			<textarea name="boset[wlist]" rows="5"><?php echo $boset['wlist'];?></textarea>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td align="center">설문등록</td>
		<td>
			<select name="boset[po_auth]">
				<option value="">사용안함</option>
				<?php echo apms_grade_options($boset['po_auth']);?>
			</select>
			등급 이상
			-
			<?php echo get_member_level_select("boset[po_level]", 1, 10, $boset['po_level']); ?>
			등급 이상 참여
			(<input type="text" name="boset[po_point]" value="<?php echo $boset['po_point'];?>" size="4" class="frm_input">
			<?php echo AS_MP;?> 적립)
		</td>
	</tr>
	</tbody>
