	...
	<?php if ($is_comment_write) { ?>
		<aside id="bo_vc_w">
			...
			<div class="comment-box">
				...
				<?php if ($is_guest) { include_once($board_skin_path.'/board.lib.php'); ?>
					<div class="form-group row">
						<div class="col-xs-6">
							<label for="wr_name" class="sound_only">이름<strong class="sound_only"> 필수</strong></label>
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-user gray"></i></span>
								<input type="text" tabindex="11" name="wr_name" value="<?php echo apms_anonymity(); ?>" id="wr_name" class="form-control input-sm" size="5" maxLength="20" placeholder="이름">
							</div>
						</div>
						<div class="col-xs-6">
					...
					<div class="form-group pull-right">
						<span class="cursor">
							<label class="checkbox-inline">
								...
								<?php echo (isset($boset['nuse']) && $boset['nuse']) ? '익명글' : '실명글';?>
							</label>
						</span>
						<span class="cursor">
