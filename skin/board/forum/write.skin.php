...
$is_use_tag = (isset($boset['tag']) && $boset['tag'] && $member['mb_level'] >= $boset['tag']) ? true : false;
$is_use_download = (isset($boset['udp']) && $boset['udp']) ? true : false;
$is_use_poll = (isset($boset['po_auth']) && $boset['po_auth'] && $member['mb_level'] >= $boset['po_auth']) ? true : false;
$is_use_reading = (isset($boset['urp']) && $boset['urp']) ? true : false;
