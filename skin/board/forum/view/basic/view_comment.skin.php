			...
			<div class="media" id="c_<?php echo $comment_id ?>"<?php echo ($cmt_depth) ? ' style="margin-left:'.$cmt_depth.'px;"' : ''; ?>>
				...
				<div class="media-body">
					<div class="media-heading">
						...
						<span style="display: inline-block; height: 18px; margin-right: 2px; border-style: solid; border-width: 1px; border-radius: 5px; padding:0 10px 0 10px; font-size: 11px; font-weight: normal; letter-spacing: -1px; line-height: 22px; text-align: center;text-indent: -1px;">글쓴이</sapn><?php } ?>
