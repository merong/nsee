...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		...
		<td>
			<label><input type="checkbox" name="wset[more]" value="1"<?php echo get_checked('1', $wset['more']); ?>> 더보기 모드</label>
			-	
			...
			버튼
			&nbsp;
			<label><input type="checkbox" name="wset[right]" value="1"<?php echo get_checked('1', $wset['right']); ?>> 이미지 우측위치</label>
		</td>
	</tr>
	<tr>
