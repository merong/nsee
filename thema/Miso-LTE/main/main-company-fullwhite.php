...
<style>
	...
	#pagetitle .item-1 { background: url('<?php echo $main_url;?>/img/bg3.jpg') no-repeat; background-size: cover; }
	#pagetitle .item-2 { background: url('<?php echo $main_url;?>/img/bg2.jpg') no-repeat; background-size: cover; }
	#pagetitle .item-3 { background: url('<?php echo $main_url;?>/img/bg1.jpg') no-repeat; background-size: cover; }
	...
	<div class="page-widget">
		...
		<div class="row">
			<div class="col-md-4">
				...
				<div class="widget-box">
					<?php echo apms_widget('miso-post-webzine', $wshid.'-webzine-m2', 'rows=3 item=1 lg=1 md=1 sm=1 date=1 bold=1'); ?>
				</div>
				<!--// End -->
