...
<form name="memo_form" action="./memo_ad_update.php" onsubmit="return memolist_submit(this);" method="post">
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <td class="td_left">
            <input type="text" name="me_send_id" value=""> 보내는 사람의 아이디를 입력하세요
        </td>
    </tr>
    <tr>
